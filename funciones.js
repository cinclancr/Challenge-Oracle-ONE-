   ...
   if(textoEncriptado != textArea || textoEncriptado == ""){
       if(textArea.trim() != ""){
           ...
           tituloAside.innerHTML = "Mensaje Encriptado:"
               ...
               swal("¡Suave un toque!","Debes ingresar el mensaje a encriptar.","error");
               area.focus()
           }
   }else{
       swal("¡Suave un toque!","Este mensaje ya fue encriptado", "warning");
   }
}
...
function desencriptarTexto(){
   ...
   if(textArea.trim() != ""){
       ...
       tituloAside.innerHTML = "Mensaje Desencriptado:"
           ...
           swal("¡Suave un toque!", "Debes ingresar el mensaje a desencriptar.", "warning");
           area.focus()
       }
}
